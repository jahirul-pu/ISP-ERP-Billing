import { IsString, IsOptional, IsEnum, IsNumber, IsUUID, IsDate } from 'class-validator';
import { Type } from 'class-transformer';
import { ApiPropertyOptional } from '@nestjs/swagger';

export class UpdateItemDto {
  @ApiPropertyOptional({ example: 'TP-Link WR840N Router' })
  @IsString()
  @IsOptional()
  name?: string;
  ...
  @ApiPropertyOptional({ enum: ['NEW', 'GOOD', 'DAMAGED', 'REPAIR', 'DISPOSED'], example: 'GOOD' })
